export function TemplateRecoverAccount({
  recover_url,
  expiration_time,
}: {
  recover_url: string;
  ...
  return `
    ...
    <html lang="es">
      <head>
        ...
        <title>Reset Your Password - UltimaTio</title>
      </head>
          ...
          <tr>
            <td style="padding: 30px;">
              ...
              <p style="font-size: 16px; margin: 0 0 20px 0; color: #2c3e50;">
                We received a request to reset the password for your UltimaTio account. If you made this request, click the button below to choose a new password.
              </p>
              <div style="text-align: center; margin: 30px 0;">
                <a href="${recover_url}" target="_blank" 
              ...
              <p style="font-size: 16px; margin: 30px 0; color: #2c3e50; text-align: center; background-color: #f5eaff; padding: 15px; border-radius: 6px;">
                This link will expire in ${expiration_time} hours. If you didn’t request a password reset, you can safely ignore this email.
              </p>
