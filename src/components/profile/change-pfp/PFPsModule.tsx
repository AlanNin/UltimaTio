      ...
      {isAboveSmallScreens ? (
        <div className="flex flex-col w-full h-full items-center">
          <header
            ...
            } justify-center p-10 gap-6 shadow-md border-b border-white border-opacity-5 bg-[#0F0F0F]`}
          >
            <ArrowLeftCircleIcon
              onClick={() => setIsChangingPFP(false)}
              strokeWidth={1.5}
              className="text-white size-10 stroke-current cursor-pointer"
            />
            <h1 className="font-medium text-4xl">Select a profile picture</h1>
          </header>
          <div className="flex flex-col h-max py-8 pt-40 gap-12">
        ...
        <>
          <header className="flex h-max z-10 w-full p-4 fixed items-center gap-x-4 shadow-md border-b border-white border-opacity-5 bg-[#0F0F0F]">
            <ArrowLeftCircleIcon
              onClick={() => setIsChangingPFP(false)}
              strokeWidth={0.8}
              className="text-white size-6 stroke-current cursor-pointer"
            />
            <h1 className="font-medium text-lg">Select a profile picture</h1>
          </header>
          <div className="flex flex-col w-full h-max py-8 pt-20 gap-6">
            <div className="flex flex-col gap-1.5">
